            ...
            new ActionListener() {
                ...
                public void actionPerformed(ActionEvent event) {
                    ...
                    if (txtEmail.getText().trim().length() == 0) {
                        lblNotificacoes.setText("É necessário digitar alguma coisa no campo Email. Por favor, digite um caracter válido no campo e-mail para prosseguir.");
                    ...
                    try {
                        ...
                        lblNotificacoes.setText("Ocorreu um problema e não será possível cadastrar nesse momento. Por favor, tente novamente mais tarde");
